                                ...
                                <form role="form" action="{{route('admin.settings.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a href="#tab_3" data-toggle="tab">Smtp Email</a></li>
                                            <li><a href="#tab_4" data-toggle="tab">About Us</a></li>
                                            <li><a href="#tab_5" data-toggle="tab">Contact Us</a></li>
                                            <li><a href="#tab_6" data-toggle="tab">Reference</a></li>
                                            <li><a href="#tab_7" data-toggle="tab">Advanced</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab_3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="smtpemail" value="{{$settings->smtpemail}}" class="form-control">
                                                </div>
