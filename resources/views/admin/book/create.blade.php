                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" style="border: 1px solid #d2d6de; max-height: 150px; overflow-x: hidden; overflow-y: scroll">
                                <div style="margin-left: 10px" class="checkbox">
                                    <label>
                                        <input type="checkbox" name="category_id[]" value="{{null}}" id="noneCheckbox" checked>
                                        none
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="quantity_available" placeholder="quantity available">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" min="1" name="edition" placeholder="edition">
                            </div>
